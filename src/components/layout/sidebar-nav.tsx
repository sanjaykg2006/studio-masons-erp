...
/**
 * Shared sidebar contents (logo + nav links + footer), rendered by both the
 * desktop {@link Sidebar} aside and the mobile drawer in `mobile-nav.tsx`.
 *
 ...
 *
 * @param onNavigate fires when a link is clicked — used by the mobile drawer to
